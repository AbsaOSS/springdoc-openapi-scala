...
object JacocoSetup {
  ...
  def jacocoSettings(springdocOpenAPIMajorVersion: Int, scalaVersion: String): JacocoReportSettings = {
    ...
    jacocoReportCommonSettings.withTitle(
      s"Jacoco Report for springdoc-openapi:$springdocOpenAPIMajorVersion - scala:$scalaVersion [$now]"
    )
  }
